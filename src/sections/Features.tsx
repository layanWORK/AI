...
const FeaturesTabs = ({ icon, title, isNew }: TabProps) => {
  return (
    <div className="border border-white/15 flex p-2.5 rounded-xl gap-2.5 items-center lg:w-full">
    ...
    <section className="py-20 md:py-24">
      <div className=" container">
        ...
        <div className=" mt-10 flex flex-col gap-3 lg:flex-row  ">
          {tabs.map((tab, index) => (
           <FeaturesTabs  {...tab}   key={tab.title} />
          ))}
        </div>
